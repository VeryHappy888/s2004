...
// SignalMessageSerializer is an iface for serializing and deserializing
// SignalMessages into bytes. An implementation of this iface should be
...
func (s *SignalMessage) VerifyMac(messageVersion int, senderIdentityKey,
	...
	logger.Debug("  Our MAC: ", hex.EncodeToString(ourMac))
	logger.Debug("  Their MAC: ", hex.EncodeToString(theirMac))*/
