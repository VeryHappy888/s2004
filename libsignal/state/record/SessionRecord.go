...
// SessionSerializer is an iface for serializing and deserializing
// a Signal Session into bytes. An implementation of this iface should be
...
func (r *Session) HasSessionState(version int, senderBaseKey []byte) bool {
	...
	// CheckNil our session state and compare the base key to this base key.
