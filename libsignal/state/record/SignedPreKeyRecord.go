...
// SignedPreKeySerializer is an iface for serializing and deserializing
// SignedPreKey objects into bytes. An implementation of this iface should be
