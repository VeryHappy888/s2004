...
func GenerateKeyPair() (*ECKeyPair, error) {
	...
	// Put data into our keypair entity
	...
	logger.Debug("private key ", hex.EncodeToString(bytehelper.ArrayToSlice(private)))
	logger.Debug("pubkey key ", hex.EncodeToString(bytehelper.ArrayToSlice(public)))*/
	return keypair, nil
}
