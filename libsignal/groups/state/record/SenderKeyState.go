...
// SenderKeyStateSerializer is an iface for serializing and deserializing
...
func (k *SenderKeyState) structure() *SenderKeyStateStructure {
	...
	var sigPriKey, sigPubKey []byte
	if k.signingKeyPair != nil {
		if k.signingKeyPair.PrivateKey() != nil {
			sigPriKey = bytehelper.ArrayToSlice(k.signingKeyPair.PrivateKey().Serialize())
		}
		if k.signingKeyPair.PublicKey() != nil {
			sigPubKey = k.signingKeyPair.PublicKey().Serialize()
		}
	...
	return &SenderKeyStateStructure{
		...
		SigningKeyPrivate: sigPriKey,
		SigningKeyPublic:  sigPubKey,
	}
}
