...
func TestSharedSecret(t *testing.T) {
	...
	// CheckNil to make sure Alice and Bob calculated the same shared secret.
	...
	// CheckNil to make sure that Alice and Bob also hashed the same secret the same way using KDF.
