...
func NewWA40() *WA40 {
	return &WA40{
		...
		waSecondaryDictionary: []string{
			...
			"Mac OS 10.14.2",
			"pt",
			"handshake-support-phone-number",
			"push",
			"silent",
			"BR",
			"nodal",
		...
		waNoiseProtocolVersion: []byte{4, 0},
	}
}
...
type WA40 struct {
	...
	waDictionary           []string
	waSecondaryDictionary  []string
	waNoiseProtocolVersion []byte
}

func (w WA40) GetWAVer() string {
	return w.waVer
}

func (w WA40) GetWADictionary() []string {
	return w.waDictionary
}

func (w WA40) GetSecondaryDictionary() []string {
	return w.waSecondaryDictionary
}

func (w WA40) GetNoiseProtocolVersion() []byte {
	return w.waNoiseProtocolVersion
}
