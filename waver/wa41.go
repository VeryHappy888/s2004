...
func NewWA41() *WA41 {
	return &WA41{
		...
		waNoiseProtocolVersion: []byte{4, 1},
	}
}
...
func (w WA41) GetWAVer() string {
	return w.waVer
}

func (w WA41) GetWADictionary() []string {
	return w.waDictionary
}

func (w WA41) GetSecondaryDictionary() []string {
	return w.waSecondaryDictionary
}

func (w WA41) GetNoiseProtocolVersion() []byte {
